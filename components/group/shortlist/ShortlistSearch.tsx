...
export default function ShortlistSearch({
  places,
  pinnedIds,
  query,
  loading,
  ...
  const open = isFocused && places.length > 0;
  ...
  return (
    <div className="px-[14px] pt-3 pb-2 flex-shrink-0 relative z-10">
      <div className="flex items-center gap-[9px] bg-surface border-[1.5px] border-white/[0.07] rounded-[14px] px-[14px] py-[10px]">
